...
![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image1.png){:loading="lazy" decoding="async"}
...
![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image3.png){:loading="lazy" decoding="async"}
...
1. Safariで拡張機能を有効化  
   ...
   「機能拡張を許可」をオンにしましょう。  
   ![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image4.png){:loading="lazy" decoding="async"}
...
3. 拡張機能の設定  
  かなり細かく設定が出来ますが、一部を紹介します。
   ![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image5.png){:loading="lazy" decoding="async"}
  ここらへんをONにしてけば、昔のTwitterがほぼ復活します。

   ![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image6.png){:loading="lazy" decoding="async"}
...
![]({{ site.baseurl }}/assets/img/2025-04-26-cpft/image2.png){:loading="lazy" decoding="async"}
...
<div class="img-cap">
  <img src="{{ '/assets/img/2025-04-26-cpft/image9.png' | relative_url }}" alt="Control Panel for Twitter の設定例 1" style="width: 200px;">
  <div>拡張機能適用前のX。（iOS版 Safari）</div>
</div>

<div class="img-cap">
  <img src="{{ '/assets/img/2025-04-26-cpft/image7.png' | relative_url }}" alt="Control Panel for Twitter の設定例 2" style="width: 200px;">
...
<div class="img-cap">
  <img src="{{ '/assets/img/2025-04-26-cpft/image10.png' | relative_url }}" alt="Control Panel for Twitter の設定例 3" style="width: 200px;">
  <div>拡張機能適用前のX。（iOS版 Safari）</div>
</div>

<div class="img-cap">
  <img src="{{ '/assets/img/2025-04-26-cpft/image8.png' | relative_url }}" alt="Control Panel for Twitter の設定例 4" style="width: 200px;">
  <div>拡張機能適用後のX。（iOS版 Safari）</div>
</div>
